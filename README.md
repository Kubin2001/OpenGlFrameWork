...
- **Flat Rendering** – ignores order very fast
- **UberShader Rendering** – no shader switch pipeline
...
### Sound Manager
Stereo audio playback with support for raw sounds(waw) and music(mp3,ogg) and recursive directory loading.
