...
public:
	...
	void RenderTextCenterPred(MT::Renderer* renderer, const std::string& text, MT::Rect &btnRect,Point &textSizes,
		float scale = 1.0, int interline = 20, int textStartX = 0, int textStartY = 0);
